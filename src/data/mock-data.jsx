...
export const LocationTab = [
    {id:1, lable:'Design', icon:<ApartmentRoundedIcon size={24}/> },
    {id:2, lable:'Arctic', icon:<SnowboardingRoundedIcon size={24}/> },
    {id:3, lable:'Shared ', icon:<HouseSidingRoundedIcon size={24}/> },
    {id:4, lable:'LakeFront', icon:<WaterRoundedIcon size={24}/>  },
    {id:5, lable:'National ', icon:<BabyChangingStationRoundedIcon size={24}/>},
    {id:6, lable:'Bed & Breakfast', icon: <BedRoundedIcon size={24}/> },
    {id:7, lable:'OMG', icon:<CrisisAlertRoundedIcon size={24}/> },
    {id:8, lable:'Camping', icon:<CabinRoundedIcon size={24}/> },
    {id:9, lable:'A-frames', icon:<FilterFramesRoundedIcon size={24}/> },
    {id:10, lable:'Domes', icon: <SpeedRoundedIcon size={24}/>},
    {id:11, lable:'Tiny Homes', icon:<BungalowRoundedIcon size={24}/> },
    {id:12, lable:'Treehouses', icon:<CottageRoundedIcon size={24}/> },
    {id:13, lable:'Surfing', icon:<SurfingRoundedIcon size={24}/> },
    {id:14, lable:'CountrySide', icon:<FilterHdrRoundedIcon size={24}/> },
    {id:15, lable:'Caves', icon:<DirectionsRailwayRoundedIcon size={24}/> },
    {id:16, lable:'Golfing', icon:<GolfCourseRoundedIcon size={24}/> },
    {id:17, lable:'Cabins', icon:<KitchenRoundedIcon size={24}/> },
    {id:18, lable:'Earth Homes', icon: <PublicRoundedIcon size={24}/>},
    {id:19, lable:'Tropical', icon:<EmojiEventsRoundedIcon size={24}/> },
    {id:20, lable:'Amazing Pools', icon:<PoolRoundedIcon size={24}/> },
